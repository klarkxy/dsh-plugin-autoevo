...
| `modify_review` | The user chose to improve this review. | Modify minimally, then resume with the local checkout path. The workflow derives `base_review_id`. At most two Host-bounded modify attempts. |
