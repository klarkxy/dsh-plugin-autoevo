...
try {
  ...
  assert.match(result.stdout, /AUTOEVO_PACKAGED_V9_SESSION_OK/u)
  const evidenceLine = result.stdout.split(/\r?\n/u).find((line) => line.includes('AUTOEVO_PACKAGED_V9_SESSION_OK'))
  ...
  assert.equal(manifest.templateVersion, '9')
