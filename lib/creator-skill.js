...
const OUTSIDE_EVOLUTION_MODE_DENIAL = "AutoEvo denied new Cordis plugin creation: start or switch a blank/new session to the Capability Evolution (evolution) agent preset. Dynamic new Cordis definitions are permitted only in Capability Evolution mode after the user explicitly allows create-new.";
//#endregion
