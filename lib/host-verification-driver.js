...
//#endregion
//#region src/lifecycle/bundle-activation.ts
...
function pushTargets(out, seen, visited, rows) {
	const pending = [...rows].reverse();
	while (pending.length > 0) {
		const rec = record$1(pending.pop());
...
//#endregion
export { VERIFICATION_STATUSES as _, sanitizeHostVerificationEvidence as a, sha256 as b, activationTargetsFromPatch as c, BRIDGE_EXECUTION_TOOLS as d, DEFAULT_REQUEST_INTENT as f, VERIFICATION_LAYER_KINDS as g, TOOL_NAMES as h, hostVerificationOverlay as i, flattenLoaderOptions as l, POLICY_VERSION as m, declaredVerificationFixturesFromPackage as n, selectInstallVerificationLayer as o, FORGED_RESUME_HOST_KEYS as p, hostLayerSuccess as r, verificationChildEnv as s, applyHostVerification as t, matchActivatedEntries as u, classifyRuntimeSurface as v, hashObject as y };
