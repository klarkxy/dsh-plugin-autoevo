import { a as EVOLUTION_MODE_SERVICE_KEY, c as EVOLUTION_PRESET_KNOWN_MANIFESTS, d as OUTSIDE_EVOLUTION_MODE_DENIAL, i as EVOLUTION_MODE_OWNER, l as EVOLUTION_PRESET_MANAGED_CONTENT_FILES, m as isEvolutionPresetManifest, n as isWorkflowSkill, p as isEvolutionModeMarker, s as EVOLUTION_PRESET_ID, u as EVOLUTION_PRESET_MANIFEST_FILENAME } from "./creator-skill.js";
...
function apply(ctx, input) {
	...
	const cordisInspect = ctx.get("cordisInspect");
	if (cordisInspect && typeof cordisInspect.register === "function") ctx.effect(() => installCordisInspectCompatibility(cordisInspect), "autoevo: share first-party Cordis Inspect providers across Creator and evolution presets");
	else log.warn("Host cordisInspect registry unavailable; Creator/evolution coexistence compatibility is inactive");
