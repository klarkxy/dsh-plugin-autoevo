...
var SourceManager = class SourceManager {
	...
	*/
	...
	async createHooklessCommit(input) {
		...
		if (!await this.git(root, ["status", "--porcelain"], input.signal)) throw new EvolutionError("invalid_input", "Managed child returned without changing the source repository");
